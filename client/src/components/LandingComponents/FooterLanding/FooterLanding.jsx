        ...
        <div className="flex flex-wrap text-left lg:text-left">
          <div className="w-full lg:w-6/12 px-4">
            ...
            <div className="mt-6 lg:mb-0 mb-3 flex">
              <div
                className="dark:bg-white bg-red-700 dark:text-black text-white shadow-lg font-normal h-10 w-10 flex items-center justify-center align-center rounded-full outline-none focus:outline-none mr-4">
                <BsFacebook />
              </div>
              <div
                className="dark:bg-white bg-red-700 dark:text-black text-white shadow-lg font-normal h-10 w-10 flex items-center justify-center align-center rounded-full outline-none focus:outline-none mr-4">
